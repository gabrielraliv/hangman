...
const words_list = ["frog", "tree", "book", "fish", "star", "milk", "door", "cake", "lamp", "shoe", "rain", "snow", "jump", "duck", "ball", "nest", "wind", "coin", "sock", "kite"];
 ...
 */
function draw_random_word(my_list) {
 ...
 */
function build_display_word(word) {
    let output = "";
 ...
 * @returns
 */
function build_display_element(word) {
    let display_element = "";
    for (let x = 0; x < word.length; x++) {
 ...
 */
function update_display_word(letter) {
    let new_display_text = "";
    let word_in = false;
 ...
 */
function update_display(new_display_text) {
